...
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, useRoute as useRoute$1, useRouter as useRouter$1 } from "vue-router";
...
import "destr";
import "klona";
import { ssrRenderAttrs, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_categoryItem_-DPKKKT6n.js")
  },
  {
    name: "categoryName",
    path: "/:categoryName()",
    component: () => import("./_nuxt/_categoryName_-CKWfPoxG.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CvWgvm8v.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-iiK9ahaU.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CsF-vEhv.js"));
